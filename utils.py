...
ALEX = [88.6428, 89.4468, 92.2640, 81.9880, 82.6268, 78.5948, 79.8360, 86.6816, 82.6572, 81.9324, 56.4592, 85.3204, 64.6056, 71.7840, 60.6500]
...
imagenet_a_mask = [wnid not in set(imagenet_a_wnids) for wnid in all_wnids]
...
imagenet_r_mask = [wnid not in set(imagenet_r_wnids) for wnid in all_wnids]
...
def get_model_and_config(model_name, ckpt_path, use_ema):
